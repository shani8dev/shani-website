document.addEventListener('DOMContentLoaded', () => {
  ...
  /* =====================================================
   *  DOWNLOAD CONFIG — single source of truth.
   *  Update version/URLs here only. All download links
   *  in the page are wired from this object by JS.
   * ==================================================== */
  const DOWNLOADS = {
    gnome: {
      iso:    'https://sourceforge.net/projects/shanios/files/gnome/20260118/signed_shanios-gnome-2026.01.18-x86_64.iso/download',
      sha256: 'https://sourceforge.net/projects/shanios/files/gnome/20260118/signed_shanios-gnome-2026.01.18-x86_64.iso.sha256/download',
    },
    plasma: {
      iso:    'https://sourceforge.net/projects/shanios/files/plasma/20260118/signed_shanios-plasma-2026.01.18-x86_64.iso/download',
      sha256: 'https://sourceforge.net/projects/shanios/files/plasma/20260118/signed_shanios-plasma-2026.01.18-x86_64.iso.sha256/download',
    },
  };

  /* Wire all download links from the config above */
  document.querySelectorAll('a[data-download]').forEach(a => {
    const [edition, type = 'iso'] = a.dataset.download.split(':');
    if (DOWNLOADS[edition]?.[type]) a.href = DOWNLOADS[edition][type];
  });
